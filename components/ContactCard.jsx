  ...
  return (
    <div className="flex flex-col gap-8 w-1/2">
      {cardDetails.map((card, ) => (
        <div key={card.id} className="bg-gradient-to-tl from-[#16180d] to-black hover:bg-gradient-to-br from-[#16180d] to-black rounded-3xl flex flex-col border border-[#181818] hover:border-purple-600 transition ease-in-out hover:scale-95 duration-300">
          <div className="h-16 w-16 ml-5 mt-5 bg-[#16180d] rounded-full transition ease-in-out hover:scale-125 duration-500">
            <div className="h-8 w-8 ml-4 mt-4">
              <Image
                className="h-full w-full"
                src={card.image}
                alt="social media" width={100} height={100}
              />
            </div>
          </div>
