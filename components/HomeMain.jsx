...
const HomeMain = () => {
  return (
    <div id="home" className="relative">
        ...
        <div>
          <div className="flex flex-col justify-center items-center text-center gap-5 pt-52 pb-0 bg-gradient-to-b from-[#000000] to-[#00000048] text-white relative z-10">
