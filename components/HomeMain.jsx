    ...
    <div id="home" className="relative">
        ...
        <div>
          <div className="flex flex-col justify-center items-center gap-5 pt-52 pb-0 bg-gradient-to-b from-[#000000] to-[#00000048] text-white relative z-10">
            ...
            <div className="font-light text-center p-10 bg-[#1a1a1a] rounded-3xl mx-52">
            ...
            <div className="flex justify-center gap-10 p-10 w-full mt-10 backdrop-blur-3xl text-white">
              <div className="flex flex-col items-center gap-5">
                ...
                <p className="font-light">Years of Experiences</p>
              </div>
              <div className="flex flex-col items-center gap-5">
                <h1 className="text-6xl font-bold">4.5K+</h1>
                <p className="font-light">Project Completed</p>
              </div>
              <div className="flex flex-col items-center gap-5">
                <h1 className="text-6xl font-bold">10.5K+</h1>
                <p className="font-light">Trusted Clients</p>
              </div>
            </div>
          </div>
        </div>
